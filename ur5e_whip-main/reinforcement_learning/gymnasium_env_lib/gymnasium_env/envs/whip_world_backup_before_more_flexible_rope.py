...
ROPE_JOINT_STIFFNESS = 0.002
ROPE_JOINT_DAMPING = 0.001
...
APPLY_ROPE_MASS_SCALE = False
ROPE_BODY_MASS_SCALE = 1.0

# If you need a stiffer rope during testing, try:
#   ROPE_JOINT_STIFFNESS = 0.008
#   ROPE_JOINT_DAMPING = 0.004
# If you need a softer rope, try:
#   ROPE_JOINT_STIFFNESS = 0.002
#   ROPE_JOINT_DAMPING = 0.001
